...
export const mockAlerts = [
  { id: 'alert-001', deviceId: 'device-003', deviceName: '设备B-001', type: '轴承磨损', level: 'high', time: '2026-03-10 20:15:32' },
  { id: 'alert-002', deviceId: 'device-008', deviceName: '设备D-002', type: '温度过高', level: 'high', time: '2026-03-10 19:42:18' },
  { id: 'alert-003', deviceId: 'device-002', deviceName: '设备A-002', type: '振动异常', level: 'medium', time: '2026-03-10 18:30:45' },
  { id: 'alert-004', deviceId: 'device-005', deviceName: '设备C-001', type: '电流波动', level: 'medium', time: '2026-03-10 17:22:10' },
  { id: 'alert-005', deviceId: 'device-001', deviceName: '设备A-001', type: '润滑油不足', level: 'low', time: '2026-03-10 15:10:05' },
];

// 模拟维护记录（更新时间+合理分配工程师岗位）
export const mockMaintenanceRecords = [
  { id: 'maint-001', deviceId: 'device-003', time: '2026-03-09 14:30:22', operator: '智能制造工程师', action: '更换轴承' },
  { id: 'maint-002', deviceId: 'device-005', time: '2026-03-08 11:15:48', operator: '智能制造工程师', action: '调整电机' },
  { id: 'maint-003', deviceId: 'device-008', time: '2026-03-07 09:40:33', operator: '智能运维工程师', action: '降温处理' },
  { id: 'maint-004', deviceId: 'device-002', time: '2026-03-06 16:20:15', operator: 'AI智能体开发工程师', action: '紧固螺栓（智能检测辅助）' },
  { id: 'maint-005', deviceId: 'device-001', time: '2026-03-05 10:05:42', operator: '智能运维工程师', action: '添加润滑油' },
  { id: 'maint-006', deviceId: 'device-004', time: '2026-03-04 15:40:18', operator: '视觉算法工程师', action: '系统校准（视觉定位辅助）' },
  { id: 'maint-007', deviceId: 'device-006', time: '2026-03-03 09:25:33', operator: '智能制造工程师', action: '更换滤芯' },
  { id: 'maint-008', deviceId: 'device-007', time: '2026-03-02 14:15:27', operator: 'AI智能体开发工程师', action: '电路检修（智能诊断辅助）' },
  { id: 'maint-009', deviceId: 'device-003', time: '2026-03-01 11:30:42', operator: '视觉算法工程师', action: '传感器更新（视觉标定）' },
  { id: 'maint-010', deviceId: 'device-008', time: '2026-02-29 16:55:19', operator: '智能运维工程师', action: '散热器更换' },
  { id: 'maint-011', deviceId: 'device-002', time: '2026-02-28 10:20:36', operator: 'AI智能体开发工程师', action: '软件升级（智能运维系统）' },
  { id: 'maint-012', deviceId: 'device-005', time: '2026-02-27 13:45:51', operator: '智能制造工程师', action: '电机清洁' },
  { id: 'maint-013', deviceId: 'device-001', time: '2026-02-26 09:10:24', operator: '智能运维工程师', action: '安全检查' },
  { id: 'maint-014', deviceId: 'device-007', time: '2026-02-25 15:35:48', operator: '视觉算法工程师', action: '电源维护（视觉检测故障）' },
  { id: 'maint-015', deviceId: 'device-004', time: '2026-02-24 11:50:33', operator: '智能制造工程师', action: '性能测试' },
];
